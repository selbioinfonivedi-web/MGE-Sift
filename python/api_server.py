...
from mge_utilities import AnalysisResult, SQLiteDatabaseManager, get_logger, LogLevel
...
@app.get(
    "/samples",
    response_model=List[SampleMetadata],
...
@app.get(
    "/results", response_model=List[ResultItem], dependencies=[Depends(verify_api_key)]
)
...
async def export_results(sample_id: Optional[str] = None, format: str = "json"):
